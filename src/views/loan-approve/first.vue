    ...
    <el-table-column label="操作" width="350">
      <template slot-scope="{row}">
        <el-button 
          ...
          @click="seeval(row)" >查看</el-button>
        <el-button 
          size="mini"
         type="success" @click="successval(row)"  
          >通过</el-button>
         <el-button
          size="mini"    type="danger" @click.once=" rejectval(row)"
          >拒绝</el-button>
                ...
                <el-row :gutter="10">
                  ...
                  <el-col :xs="24" :sm="12" :md="8" :lg="8">
                    <el-form-item label="性别">
                     <sapn class="filter-item" />{{temp.sex|getsex}}
                   </el-form-item>
                  </el-col>
                </el-row>
                <el-row :gutter="10">
...
<script>
import { approvefirstlist, approvefirstpass,approvefirstreject,loanquery} from '@/api/article.js'
